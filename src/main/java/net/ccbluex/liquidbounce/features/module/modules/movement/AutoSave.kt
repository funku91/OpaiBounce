...
object AutoSave : Module("AutoSave", Category.MOVEMENT) {
    ...
    // AutoFreeze
    private val autoFreeze by boolean("AutoFreeze", true)
    private val freezeOnlyVoid by boolean("FreezeOnlyVoid", true) { autoFreeze }
    private val freezeFallDistance by int("FreezeFallDistance", 5, 1..50) { autoFreeze }

    // AutoScaffold
    private val autoScaffold by boolean("AutoScaffold", true)
    private val scaffoldOnlyVoid by boolean("ScaffoldOnlyVoid", true) { autoScaffold }
    private val scaffoldVoidDistance by int("ScaffoldVoidDistance", 1, 1..50) { autoScaffold }
    private val scaffoldOnHit by boolean("ScaffoldOnHit", true) { autoScaffold }
    private val scaffoldInCombat by boolean("ScaffoldInCombat", true) { autoScaffold }
