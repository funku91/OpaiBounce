...
object NoSlow : Module("NoSlow", Category.MOVEMENT, gameDetecting = false) {
    ...
    private val swordMode by choices(
        "SwordMode",
        arrayOf("None", "NCP", "UpdatedNCP", "AAC5", "SwitchItem", "InvalidC08", "Blink","PostPlace", "GrimAC", "BlocksMC"),
        "None"
    )
    ...
    private val consumeMode by choices(
        "ConsumeMode",
        arrayOf("None", "UpdatedNCP", "AAC5", "SwitchItem", "InvalidC08", "Intave", "Drop", "BlocksMC"),
        "None"
    )
