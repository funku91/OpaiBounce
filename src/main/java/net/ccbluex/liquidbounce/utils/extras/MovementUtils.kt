...
object MovementUtils : MinecraftInstance {
    ...
    fun FlyBasic(speed: Float) {
        ...
        net.ccbluex.liquidbounce.utils.movement.MovementUtils.strafe(speed)
    }
    ...
    fun strafe() {
        net.ccbluex.liquidbounce.utils.movement.MovementUtils.strafe(getSpeed())
    }
    ...
    fun strafe(event: MoveEvent, speed: Float) {
       ...
       event.z = cos(net.ccbluex.liquidbounce.utils.movement.MovementUtils.direction) * speed
    }
    ...
    fun doTargetStrafe(
        ...
        strafe_ *= _direction
        var strafeYaw = net.ccbluex.liquidbounce.utils.rotation.RotationUtils.getRotationsEntity(curTarget).yaw.toDouble()
    ...
    fun move(speed: Float) {
        if (!net.ccbluex.liquidbounce.utils.movement.MovementUtils.isMoving()) return
        val yaw = net.ccbluex.liquidbounce.utils.movement.MovementUtils.direction
    ...
    val movingYaw: Float
        get() = (net.ccbluex.liquidbounce.utils.movement.MovementUtils.direction * 180f / Math.PI).toFloat()
