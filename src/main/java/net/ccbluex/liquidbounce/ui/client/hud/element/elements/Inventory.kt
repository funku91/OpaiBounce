...
class Inventory : Element("Inventory", 300.0, 50.0) {
    ...
    private val opaiBar by boolean("OpaiBar",true)
    private val Shadow by boolean("Shadow",false) {opaiBar}
    ...
    override fun drawElement(): Border {
        ...
        if (opaiBar) drawRoundedRect(0F,startY,width,4F,Color(77,139,199,120).rgb,roundedRectRadius, RenderUtils.RoundedCorners.TOP_ONLY)
