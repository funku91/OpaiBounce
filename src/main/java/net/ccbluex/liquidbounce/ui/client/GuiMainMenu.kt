...
class GuiMainMenu : AbstractScreen() {
    ...
    private fun showWelcomePopup() {
        popup = PopupScreen {
            title("§a§lWelcome!")
            message("""
                §eThank you for downloading and installing §bObai§e!
    ...
    private fun showUpdatePopup() {
        ...
        popup = PopupScreen {
            ...
            message("""
                §eA new $updateType of Opai is available!
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        drawImage(ResourceLocation("${CLIENT_NAME.lowercase()}/logo_icon.png"), width / 2 - 25, height / 8, 50, 50, Color(255,255,255,250))
        //Fonts.fontBold180.drawCenteredString(CLIENT_NAME, width / 2F, height / 8F, 16433213, true)
