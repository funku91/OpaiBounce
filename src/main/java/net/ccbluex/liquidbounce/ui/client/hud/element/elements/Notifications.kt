...
class Notifications(
    ...
    val padding by int("Padding", 5, 0..20)
    ...
    enum class SeverityType(val path: ResourceLocation) {
        SUCCESS(ResourceLocation("${CLIENT_NAME.lowercase()}/notifications/success.png")), RED_SUCCESS(ResourceLocation("${CLIENT_NAME.lowercase()}/notifications/redsuccess.png")), INFO(
            ResourceLocation("${CLIENT_NAME.lowercase()}/notifications/info.png")
        ),
        WARNING(ResourceLocation("${CLIENT_NAME.lowercase()}/notifications/warning.png")), ERROR(ResourceLocation("${CLIENT_NAME.lowercase()}/notifications/error.png"))
    }
}
