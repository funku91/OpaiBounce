...
object Fonts : MinecraftInstance {
    ...
    fun downloadFonts() {
        ...
        if (!outputFile.exists()) {
            ...
            val localResource = "/assets/minecraft/${CLIENT_NAME.lowercase()}/fonts/outfit.zip"
    ...
    private fun getFontFromFileOrNull2(file: String, size: Int): Font? = try {
        val resourcePath = "/assets/minecraft/opai/fonts/$file"
    ...
    private fun getFontFromFile2(file: String, size: Int): Font =
        getFontFromFileOrNull2(file, size)?: Font("default", Font.PLAIN, size)
