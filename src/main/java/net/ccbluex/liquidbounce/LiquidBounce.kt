...
object LiquidBounce {
    ...
    const val CLIENT_NAME = "Op"+"ai"
    const val CLIENT_AUTHOR = "pickbowen"
    const val CLIENT_CLOUD = "https://proxy.bzym.fun/https://cloud.liquidbounce.net/LiquidBounce"
    const val CLIENT_WEBSITE = "www.Opai.com"
    const val CLIENT_GITHUB = "https://github.com/CCBlueX/LiquidBounce"

    const val MINECRAFT_VERSION = "1.8.9"
    
    val clientVersionText = "b5.1"
    ...
    val clientTitle = CLIENT_NAME+ "-" + clientVersionText + " 20250913-1545"
